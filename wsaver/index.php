<?php
	...
	if(isset($_POST['submit']))
	{
		...
		$query = "select * from users where enroll='$enroll' AND password='$pass'";
			...
			<div class="wrap-login100">
				<form action="index.php" class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 validate-input" ">
						<input class="input100" type="text" name="enroll">
						<span class="focus-input100" data-placeholder="Enrollment"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" >
						...
						<span class="focus-input100" name="pass" data-placeholder="Password"></span>
					</div>
